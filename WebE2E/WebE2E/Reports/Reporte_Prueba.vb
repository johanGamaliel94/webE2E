...
Public Class Reporte_Prueba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebE2E.Reporte_Prueba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Prueba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Prueba = New Reporte_Prueba()
        rpt.Site = Me.Site
        Return rpt
    End Function
